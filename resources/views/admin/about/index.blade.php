        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="{{url('admin/about')}}"><i class="fa fa-refresh"></i>刷新</a>
    ...
    <script>
        ...
        function delCate(cate_id) {
            layer.confirm('您确认要删除这个客户信息吗？', {
             ...
             $.post('{{url('admin/about/')}}'+'/'+cate_id,{'_method':'delete','_token':'{{csrf_token()}}'},function (data) {
               if(data.status == 0){

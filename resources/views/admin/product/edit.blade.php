...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/product/'.$field->id)}}" method="post">
            <input type="hidden" name="_method" value="put">  {{--put 方式提交表单--}}
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                <tr>
                    <th width="120"><i class="require">*</i>产品类型：</th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"  name="productCode" value="{{$field->productCode}}">
                ...
                <tr>
                    <th>产品名称：</th>
                    <td>
                        <input type="text" name="productName" value="{{$field->productName}}">
                    </td>
                </tr>
                <tr>
                    <th>单位：</th>
                    <td>
                        <input type="text" name="unit" value="{{$field->unit}}">
                    </td>
                </tr>
                <tr>
                    <th>产品说明：</th>
                    <td>
                        <input class="lg" type="text" name="remark" value="{{$field->remark}}">
                    </td>
                </tr>
             {{--   <tr>
                    <th>缩略图：</th>

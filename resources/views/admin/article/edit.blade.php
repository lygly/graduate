            ...
            <table class="add_tab">
                <tbody>
                   ...
                   <tr>
                       <th>关键字：</th>
                       <td>
                           <input type="text" name="art_tag" value="{{$field->art_tag}}">
                       </td>
                   </tr>
                   <tr >
                       <th>文章描述：</th>
                       <td> <span><i class="fa fa-exclamation-circle yellow"></i>文章描述不多于50字</span>
                   ...
                   <tr>
                       ...
                       <td>
                           <span><i class="fa fa-exclamation-circle yellow"></i>文章内容必须填写</span>
                           {{--文本框插件--}}
